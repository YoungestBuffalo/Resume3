  ...
  return (
    <div>
      <CenteredTextComponent headerLevel={1} headerText="Cobble Climber">
       ...
       The original goal of Cobble Climber was to release a completed mobile game release on the Google Play Store. The game is currently released, and the project was a great learning experience. The game was developed in 2023, and the technologies used were Unity, Piskel, and Abelton Live, Code for Unity is written in C#.
       <hr/>
       The game is currently available on the Google Play Store. The game is a simple endless runner, where the player must climb a mountain of cobblestones. The player must avoid falling off the mountain, and avoid falling rocks. Below is the desktop version of the game, right click to jump. Or if you have an you can <a href="https://play.google.com/store/apps/details?id=com.DefaultCompany.Endless_Jumper&hl=en_US">get it on google play!</a>
       <sub>The web player is only available for desktop, may have issues on some browsers, folks on mobile should checkout the downloadable version above.</sub>
      </ImageTextComponent>
    <iframe
