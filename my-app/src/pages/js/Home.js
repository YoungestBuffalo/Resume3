...
const Home = () => {
    return (
        <div>
            ...
            Welcome to my website! I'm an experienced web developer passionate about creating innovative, efficient, and user-friendly digital solutions. Feel free to explore my work, learn more about my skills, and get in touch. Thank you for visiting!           
            </CenteredTextComponent>
            <CenteredTextComponent headerLevel={2} headerText="Julian Orr | Full-Stack Developer & Tech Enthusiast">
            In my healthcare career at Highmark Health, I've adapted to changes and taken on varied roles. Starting as a web author for <a href='https://www.ahn.org/'>ahn.org</a>, I transitioned to full-time QA, refining my attention to detail. Working on a Cypress test suite for the <a href='https://www.highmark.com/'>highmark.com</a> Scrum Team renewed my interest in software development, leading to my current role as a developer at enGen. My diverse experiences equip me with a unique perspective and skills that I bring to all my work.          
            </CenteredTextComponent>
            <ImageTextComponent imageSrc={profileImage} altText="Profile">
            I've navigated diverse roles. Starting as a web author, I transitioned to QA, ensuring digital platforms' functionality. I contributed to a Cypress test suite for the Highmark.com Scrum Team, showcasing my proficiency in testing and automation. Now, as a developer at enGen, I drive innovation and deliver top-notch solutions.            
            </ImageTextComponent>
            <ImageTextComponent imageSrc={projectImage} altText="Projects" reverse>
            After briefly pursuing a degree in wildlife biology, I shifted my focus towards the tech industry. I took classes at CCAC to delve into IT before immersing myself in a three-month tech bootcamp. Graduating in 2019 from the coding bootcamp <a href='https://www.academypgh.com/'>Academy PGH</a> marked a pivotal moment in my journey, igniting my passion for software development and paving the way for my subsequent career in the healthcare industry.
            <hr></hr><br />
            ...
            Meet Scout, my spirited tabby companion. He brings joy and companionship into my life with his playful, and occasionally malicious nature. Whether by my side as I work or nipping at my heels when I am walking up the stairs with arms full, Scout's presence adds warmth and levity to each day, reminding me to cherish life's simple pleasures.
            </ImageTextComponent>
        </div>
    );
};
